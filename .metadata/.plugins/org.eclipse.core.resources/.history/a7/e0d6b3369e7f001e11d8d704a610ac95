...
unsigned int ctime, ltime, interval1, interval2, readpin;
...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_pin)
{
	if(GPIO_pin == GPIO_PIN_0)
	{
		...
		interval1 = ctime - ltime;
		ltime = ctime;
		interval2 = ctime - ltime;
...
//			if (interval < 300)
//			{
//				printf("interval is %d  -> double click state\r\n", interval);
//			}
		}



//		readpin = HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_13);
...
//	  readpin = HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_13);
//	  printf("readpin = %d\r\n", readpin);
    /* USER CODE END WHILE */
